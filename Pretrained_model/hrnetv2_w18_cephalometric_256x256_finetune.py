...
train_pipeline = [
    ...
    dict(type='PackPoseInputs', 
         instance_keys=('bbox', 'bbox_scores', 'keypoints', 'keypoints_visible'), # Explicitly define instance keys
         meta_keys=('id', 'img_id', 'img_path', 'ori_shape', 'img_shape', 'flip_indices', 'center', 'scale', 'input_center', 'input_scale', 'input_size', 'patient_text_id', 'set', 'class'))
]
val_pipeline = [
